...
class TestNotebook(unittest.TestCase):
    ...
    def test_mean_square_error(self):
        self.assertEqual(a1.mean_square_error([3, 4], [1, 5]), 2.5)
        self.assertEqual(a1.mean_square_error([3.5, 4], [1, 1]), 7.625)
        self.assertEqual(a1.mean_square_error([-3.5, -3.5], [3.5, -3.5]), 24.5)
        self.assertEqual(a1.mean_square_error([3.5, -3.5], [3.5, -3.5]), 0.0)
